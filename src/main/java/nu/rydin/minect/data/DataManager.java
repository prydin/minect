...
public class DataManager {
  ...
  public DataManager(File regionPath, BlockMapper cm) {
    super();
    regionCache = new Cache2kBuilder<Point, MCAFile>() {}.eternal(true).entryCapacity(8).build();
    surfaceCache =
        new Cache2kBuilder<Surface.Key, Surface>() {}.eternal(true)
            .entryCapacity(100000)
            .permitNullValues(true)
            .build();
    sliceCache =
        new Cache2kBuilder<Slice.Key, Slice>() {}.eternal(true)
            .entryCapacity(100000)
            .permitNullValues(true)
            .build();
