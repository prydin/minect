...
public class BlockMapper {
  ...
  private final Set<String> unknowns = new HashSet<>();

  private final Map<String, Short> nameToIndex = new HashMap<>();

  private final ArrayList<BlockType> blockTypes = new ArrayList<>();
  ...
  public BlockMapper(URL blockFile, URL biomeFile) throws IOException {
    ...
    undefinedId = getIdForName("minecraft:undefined");
  }
  ...
  public Color mapColor(int blockId, int biome) {
    ...
    if (bm != -1 && biomes[biome] != null) {
      ...
      return new Color(
          (base.getRed() * multiplier.getRed()) / 255,
